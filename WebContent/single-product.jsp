                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="product-breadcroumb">
                            ...
                            <a href=""><%=productService.getCategoryName(product.getProductCategoryId()) %></a>
                            <a href="ProductServlet?productID=<%= product.getProductId()%>"><%=product.getProductName() %></a>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    ...
                                    <div class="product-inner-price">
                                        <ins>$<%=product.getProductPrice() %></ins> <del>$<%=product.getProductPricePromotion() %></del>
                                    </div>    
                                    ...
                                    <div class="product-inner-category">
                                        <p>Mặt hàng: <a href=""><%=productService.getCategoryName(product.getProductCategoryId()) %></a>
                                    </div> 
