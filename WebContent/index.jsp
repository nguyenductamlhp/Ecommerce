							...
							%>
                                ...
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        <a href="CartServlet?productID=<%=listProduct.get(i).getProductId() %>&quantity=1" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="ProductServlet?productID=<%=listProduct.get(i).getProductId() %>" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                                </div>                                
