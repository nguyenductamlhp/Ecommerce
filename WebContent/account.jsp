...
<html lang="vi">
  ...
  <body>
	...
	<ul>
		<li>Username: <%=account.getUsername() %></li>
		<li>Password: <%=account.getPassword() %></li>
		<li>Fullname: <%=account.getFullName() %></li>
	</ul>	
	<%
	if (account.getUsername().equals("admin")) {
	%>
	<ul>
		<li><a href="admin_product.jsp">Quản lý sản phẩm</a></li>
		<li><a href="admin_category.jsp">Quản lý mặt hàng</a></li>
	</ul>
	<%
	}
	%>    
